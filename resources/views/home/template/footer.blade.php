        ...
        <div class="row g-5 d-felx justify-content-between">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href="https://www.youtube.com/@pdamtirtaintankabupatengar7728"><i class="fab fa-youtube"></i></a>
                    <a href="https://www.instagram.com/tirtaintangarut/"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
